...
class ClinicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinic" do
    assert_difference("Clinic.count") do
      post clinics_url, params: { clinic: { display_name: @clinic.display_name, lat: @clinic.lat, lon: @clinic.lon, status: @clinic.status } }
    end
  ...
  test "should update clinic" do
    patch clinic_url(@clinic), params: { clinic: { display_name: @clinic.display_name, lat: @clinic.lat, lon: @clinic.lon, status: @clinic.status } }
